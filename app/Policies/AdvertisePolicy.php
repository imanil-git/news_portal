...
class AdvertisePolicy
{
    ...
    {
        return $user->can('view-any Advertise');
    }
    ...
    {
        return $user->can('view Advertise');
    }
    ...
    {
        return $user->can('create Advertise');
    }
    ...
    {
        return $user->can('update Advertise');
    }
    ...
    {
        return $user->can('delete Advertise');
    }
    ...
    {
        return $user->can('restore Advertise');
    }
    ...
    {
        return $user->can('force-delete Advertise');
    }
}
